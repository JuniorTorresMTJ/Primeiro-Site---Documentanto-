            ...
            <section class="wrapper text-dark" id="our-blog">>
                <div class="container">
                        <div class="row p-3">
                                ...
                                <div class="new1 p-3 position-relative art2">
...
Recomendo a todo bom advogado assistir para além de curtir um momento tranquilo... 
                            ...
                            <div class="col-sm-4">
                                    <div class="form">
                                        <h3  class="pb-3 text-center " style="color: white">Não perca nenhuma novidade!<br>Cadastre-se para receber nossos conteúdos <b> EXCLUSIVOS !</b> :</h3>
                      ...
                      <a href="https://artigo1.documentando.com.br/8878/how-im-em.pdf"><div class="col-sm-8">
                            <div class="new1 p-3 position-relative">
                                <h3 class="m-2 text-center text-uppercase font-x2 art2">
                                    <strong>Como a gestão eletrônica impacta a rotina empresarial?</strong>
                                </h3>
                                <div class="nomezinhos">
                                    <div ><h5  class="tipo-doc"> ARTIGO|</h5></div>
                                    <div class="author"><h6>Por Por Júlia Innocencio</h6></div>
                                </div>
                                <figure class="position-relative">
                                    <a href="https://artigo1.documentando.com.br/8878/how-im-em.pdf">
                                        <img src="./img/new2.jpg"  class="img-new1">
                                    </a>
                                </figure><p>
                                    ...
                                    A facilidade em encontrar esses documentos é justamente o destaque... </p>
                                <footer class="text-right">
                                    <button class="btn">
                                        <a href="https://artigo1.documentando.com.br/8878/how-im-em.pdf">
                                            <h4 style="color: red">MATERIAL LIMITADO</h4>
                                        </a>
                                    </button>
                                </footer>
                            </div>
                        ...
                        <a href="http://cadastro.documentando.com.br"><div class="col-sm-8">
                                <div class="new1 p-3 position-relative art2">
                                        <h3 class="m-2 text-center text-uppercase  font-x2">
                                           <strong> Como beneficiar sua empresa com automação do conhecimento</strong></h3>
                                        <div class="nomezinhos">
                                        ...
                                        <figure class="position-relative">
                                            ...
                                            realidade. A verdade é que atualmente nenhuma IA disponível...  </p>
                                        <footer class="text-right">
                                            <button class="btn">
                                                <a href="http://cadastro.documentando.com.br">
                                                    <h4 style="color: red">MATERIAL EXCLUSIVO</h4>
                                                </a>
                                            </button>
                                        </footer>
                                    </div>
